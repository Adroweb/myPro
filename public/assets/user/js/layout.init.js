    ...
    function ListMenuView() {
        $('.leftbar-action').on('click', function (event) {
            ...
            if (pCon.hasClass('list-menu-view')) {
                ...
                pOff.removeClass('col-md-4');
                pOff.addClass('col-md-2');
                pIco.removeClass('col-md-6');
                pIco.addClass('col-md-8');

            } else {
                pCon.removeClass('hide-list-menu');
                pCon.addClass('list-menu-view');
                pOff.removeClass('col-md-2');
                pOff.addClass('col-md-4');
                pIco.removeClass('col-md-8');
                pIco.addClass('col-md-6');
            }
